...
public class CalculatorExceptionHandler
{
    ...
    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY, reason = "Number too large")
    public ResponseEntity<List<CustomErrorResponse>> CalculatorNumberTooLargeException(MethodArgumentNotValidException e)
    {
